...
void Aviao:: setDecolou(bool decolou) {
	this->decolou = decolou;
}

void Aviao:: setEmDecolagem(bool emDecolagem) {
	this->emDecolagem = emDecolagem;
}

void Aviao:: setMultVelAviaoInicial(GLfloat multVelAviaoInicial) {
	this->multVelAviaoInicial = multVelAviaoInicial;
}

void Aviao:: setMultVelAviao(GLfloat multVelAviao) {
	this->multVelAviao = multVelAviao;
}

void Aviao:: setMultVelTiroInicial(GLfloat multVelTiroInicial) {
	this->multVelTiroInicial = multVelTiroInicial;
}

void Aviao:: setMultVelTiro(GLfloat multVelTiro) {
	this->multVelTiro = multVelTiro;
}

void Aviao:: setVelAviao(GLfloat velAviao) {
	this->velAviao = velAviao;
}

void Aviao:: setAnguloAviaoGrausInicial(GLdouble anguloAviaoGrausInicial) {
	this->anguloAviaoGrausInicial = anguloAviaoGrausInicial;
}

void Aviao:: setAnguloAviaoGraus(GLdouble anguloAviaoGraus) {
	this->anguloAviaoGraus = anguloAviaoGraus;
}

void Aviao:: setAnguloAviaoRadianos(GLdouble anguloAviaoRadianos) {
	this->anguloAviaoRadianos = anguloAviaoRadianos;
}

bool Aviao:: getDecolou(void) const {
	return decolou;
}

bool Aviao:: getEmDecolagem(void) const {
	return emDecolagem;
}

GLfloat Aviao:: getMultVelAviaoInicial(void) const {
	return multVelAviaoInicial;
}

GLfloat Aviao:: getMultVelAviao(void) const {
	return multVelAviao;
}

GLfloat Aviao:: getMultVelTiroInicial(void) const {
	return multVelTiroInicial;
}

GLfloat Aviao:: getMultVelTiro(void) const {
	return multVelTiro;
}

GLfloat Aviao:: getVelAviao(void) const {
	return velAviao;
}

GLdouble Aviao:: getAnguloCanhaoGraus(void) const {
	return anguloCanhaoGraus;
}

GLdouble Aviao:: getAnguloCanhaoRadianos(void) const {
	return anguloCanhaoRadianos;
}

GLdouble Aviao:: getAnguloAviaoGraus(void) const {
	return anguloAviaoGraus;
}

GLdouble Aviao:: getAnguloAviaoGrausInicial(void) const {
	return anguloAviaoGrausInicial;
}

GLdouble Aviao:: getAnguloAviaoRadianos(void) const {
...
Bomba* Aviao:: Bombardear(void) {
	...
	GLfloat raioBomba = circuloAviao->getRaio() / 2.0f;
